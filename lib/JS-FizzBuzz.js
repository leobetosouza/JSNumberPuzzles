...
exports.FizzBuzz = function( param ) {
  ...
  if ( param !== undefined ) {
    ...
    throw new Error('Sorry, but I only can extract FizzBuzz of a Number');
...
exports.Kafifa = function( param ) {
  ...
  if ( param !== undefined ) {
    ...
    if ( typeof param === 'number' ) {
      ...
      return _kafifa( param );

    }

    throw new Error('Sorry, but I only can extract Kafifa of a Number');
